package fr.eni.ex1.repository;

import fr.eni.ex1.MyApp;
import fr.eni.ex1.config.Constants;
import fr.eni.ex1.config.audit.AuditEventConverter;
import fr.eni.ex1.domain.PersistentAuditEvent;
...
import static fr.eni.ex1.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
